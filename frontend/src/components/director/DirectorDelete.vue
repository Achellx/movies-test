...
import { useDeleteDirector } from '@/composables/useDirectors'
...
const busy = computed(() => deleteDirector.isPending.value);

async function handleDelete() {
    try {
        await deleteDirector.mutateAsync(props.director.id);
